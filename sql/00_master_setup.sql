...
CREATE TABLE etl_control.batch_runs (
    ...
    start_time DATETIME2 DEFAULT DATEADD(HOUR, 7, GETUTCDATE()),
    end_time DATETIME2,
...
CREATE TABLE staging.misa_sale_orders_flattened (
    ...
    order_sale_order_no NVARCHAR(50) NOT NULL,
    ...
    order_created_date DATETIME2,
    order_modified_date DATETIME2,
    order_approved_date DATETIME2,
    order_campaign_name NVARCHAR(255),
    order_quote_name NVARCHAR(255),
    order_opportunity_name NVARCHAR(255),
    order_description NVARCHAR(MAX),
    order_billing_account NVARCHAR(255),
    order_parent_name NVARCHAR(255),
    order_recorded_sale_organization_unit_name NVARCHAR(255),
    order_recorded_sale_users_name NVARCHAR(255),
    order_created_by NVARCHAR(255),
    order_modified_by NVARCHAR(255),
    order_tag NVARCHAR(MAX),
    order_form_layout NVARCHAR(100),
    order_promotion_applied NVARCHAR(MAX),
    order_list_product NVARCHAR(MAX),
    order_list_product_category NVARCHAR(255),
    order_is_deleted BIT,
    order_is_public BIT,
    order_is_correct_route BIT,
    order_is_visited BIT,
    order_is_parent_sale_order BIT,
    order_is_invoiced BIT,
    order_is_sync_price_after_discount BIT,
    order_production_confirmation_status NVARCHAR(100),
    order_production_status NVARCHAR(100),
    order_production_rejection_reason NVARCHAR(MAX),
    order_approved_status NVARCHAR(100),
    order_approver NVARCHAR(255),
    order_custom_field1Summary DECIMAL(15,2),
    order_custom_field13 NVARCHAR(MAX),
    order_custom_field1 NVARCHAR(MAX),
    order_discount_overall DECIMAL(15,2),
    order_tax_overall DECIMAL(15,2),
    order_total_overall DECIMAL(15,2),
    order_discount_overall_oc DECIMAL(15,2),
    order_tax_overall_oc DECIMAL(15,2),
    order_total_overall_oc DECIMAL(15,2),
    order_discount_percent_overall DECIMAL(5,2),
    order_tax_percent_overall DECIMAL(5,2),
    order_to_currency_after_discount_summary DECIMAL(15,2),
    order_to_currency_oc_after_discount_summary DECIMAL(15,2),
    order_shipping_amount_summary DECIMAL(15,2),
    order_sale_order_process_cost DECIMAL(15,2),
    order_liquidate_amount DECIMAL(15,2),
    order_to_currency_summary_oc DECIMAL(15,2),
    order_discount_summary_oc DECIMAL(15,2),
    order_tax_summary_oc DECIMAL(15,2),
    order_total_summary_oc DECIMAL(15,2),
    order_liquidate_amount_oc DECIMAL(15,2),
    order_sale_order_amount_oc DECIMAL(15,2),
    order_total_receipted_amount_oc DECIMAL(15,2),
    order_balance_receipt_amount_oc DECIMAL(15,2),
    order_invoiced_amount_oc DECIMAL(15,2),
    ...
    item_to_currency_oc DECIMAL(15,2),
    item_discount_oc DECIMAL(15,2),
    item_tax_oc DECIMAL(15,2),
    item_total_oc DECIMAL(15,2),
    item_to_currency_oc_after_discount DECIMAL(15,2),
...
CREATE TABLE staging.tiktok_shop_order_detail (
    ...
    region NVARCHAR(50),
    cancel_order_sla_time DATETIME2,
    collection_due_time DATETIME2,
    ...
    paid_time DATETIME2,
    recommended_shipping_time DATETIME2,
    rts_sla_time DATETIME2,
    shipping_due_time DATETIME2,
    shipping_provider NVARCHAR(200),
    shipping_provider_id NVARCHAR(100),
    shipping_type NVARCHAR(100),
    tts_sla_time DATETIME2,
