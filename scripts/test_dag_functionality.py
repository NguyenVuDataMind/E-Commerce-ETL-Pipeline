...
def test_transformation_logic():
    ...
    try:
        ...
        transformed_shopee_df = shopee_transformer.transform_orders_to_flat_dataframe(sample_shopee_orders)
...
def test_token_refresh_logic():
    ...
    try:
        ...
        logger.info(f"✅ Refresh token expiry check: {'Expired' if is_refresh_expired else 'Valid'}")
...
def test_configuration():
    ...
    try:
        ...
        required_attrs = ['database_url', 'misa_api_url', 'tiktok_api_url', 'shopee_api_url']
